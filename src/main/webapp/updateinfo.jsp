...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="advername"  value="${advertisement.advername}" class="layui-input">
            <input type="hidden" name="id"  value="${advertisement.id}" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="advercategory"  value="${advertisement.advercategory}" value="" class="layui-input">
            <!--            <tip>填写自己管理账号的名称。</tip>-->
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <select name="adverphoto" lay-verify="required"   lay-search id="sel1" >
                <option value="${advertisement.adverphoto}">${advertisement.adverphoto}</option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <select name="adverlink" lay-verify="required"   lay-search id="sel2">
                <option value="${advertisement.adverlink}">${advertisement.adverlink}</option>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label required">跳转链接</label>
        <div class="layui-input-block">
            <input type="text" name="islink"  value="${advertisement.islink}" class="layui-input">
            <tip>不跳转则不填写。</tip>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <select name="advertanchuang" lay-verify="required"   lay-search id="sel3">
                <option value="${advertisement.advertanchuang}">${advertisement.advertanchuang}</option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="wordshow"  value="${advertisement.wordshow}" class="layui-input">
            <!--            <tip>填写自己管理账号的名称。</tip>-->
        </div>
    </div>
    ...
    <div class="layui-form-item" id="imgs">
        ...
        <div class="layui-upload">
            ...
            <div class="layui-upload-list">
                <img class="layui-upload-img" id="demo1" src="${advertisement.adverimgurl}">
                <p id="demoText"></p>
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item" id="texts">
        ...
        <div class="layui-input-block">
            <textarea id="demo" style="display: none;" lay-verify="content">${advertisement.advertext}</textarea>
        </div>
    </div>
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            $.ajax({
                ...
                success: function(data){
                    if(data.type==="yes"){
                        layer.msg("更新成功", {icon: 6},{time:4000});
